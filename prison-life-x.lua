...
function library.Create(options)
	...
	TextLabel_6.Text = "Lunar Premium"
...
telep = game.Players.LocalPlayer.Character.HumanoidRootPart
...
local Page1 = Tap1.CreatePage({
	...
	Page1.CreateLable({
        ...
        Page1.CreateButton({
                Name = "Anti Arrest(InDev)",
                Value = false,
                Callback = function(v)
		game:GetService("ReplicatedStorage").Events.Arrest:Destroy()
		game:GetService("Players").LocalPlayer.Status.Arrested:Destroy()
		game:GetService("Players").LocalPlayer.PlayerScripts.ClientInputHandler.Tased:Destroy()
        end,
        })
	...
	Page1.CreateButton({
		...
		game:GetService("ReplicatedStorage").Events.KickPlayer:Destroy()
		game:GetService("ReplicatedStorage").Events.BanPlayer:Destroy()
	end,
	})
	...
	Page1.CreateButton({
		...
		game:GetService("StarterGui"):SetCore("SendNotification",{
			Title = "Anti Byfron", 
			Text = "Remove Report User!", 
			Icon = ""
		})
		game:GetService("ReplicatedStorage").Events.ReportUser:Destroy()
	end,
	})
...
local Page3 = Tap1.CreatePage({
	...
	Page3.CreateButton({
		Name = "Criminal Base",
		Callback = function(v)
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1491.2962646484375, 67.0211181640625, 1334.6715087890625)
	end,
	})
	...
	Page3.CreateButton({
		Name = "Jail",
		Callback = function(v)
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1968.92138671875, 170.31813049316406, 2860.05126953125)
	end,
	})
	...
	Page3.CreateButton({
		Name = "Helicopter",
		Callback = function(v)
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1794.933349609375, 180.0247802734375, 2694.33642578125)
	end,
	})
	...
	Page3.CreateButton({
		Name = "Police Base 1",
		Callback = function(v)
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1836.437255859375, 155.52284240722656, 2682.64111328125)
	end,
	})
	...
	Page3.CreateButton({
		Name = "Police Base 2",
		Callback = function(v)
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2253.96533203125, 155.39312744140625, 2666.592529296875)
	end,
	})
	...
	Page3.CreateButton({
		Name = "Tower 1",
		Callback = function(v)
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1847.349609375, 185.55592346191406, 3007.91064453125)
	end,
	})
	...
	Page3.CreateButton({
		Name = "Tower 2",
		Callback = function(v)
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1530.1033935546875, 185.56234741210938, 2730.32177734375)
	end,
	})
...
local itemtp = Tap1.CreatePage({
	...
	itemtp.CreateButton({
		Name = "Key Card",
		Callback = function(v)
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2290.745361328125, 158.19271850585938, 2720.13671875)
	end,
	})

	itemtp.CreateButton({
		Name = "UZI / Remington 870",
		Callback = function(v)
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1844.291259765625, 155.9267578125, 2689.265625)
	end,
	})
	...
	itemtp.CreateButton({
		Name = "HK416",
		Callback = function(v)
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1866.52001953125, 155.52284240722656, 2675.530029296875)
	end,
	})
	...
	itemtp.CreateButton({
		Name = "Remington 700",
		Callback = function(v)
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1738.6146240234375, 155.57667541503906, 2799.58203125)
	end,
	})
	...
	itemtp.CreateButton({
		Name = "AK-47 / RPG",
		Callback = function(v)
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(38.7432975769043, 148.41064453125, 918.8226318359375)
	end,
	})
	...
	itemtp.CreateButton({
		Name = "Minigun",
		Callback = function(v)
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1471.035400390625, 67.62289428710938, 1329.951171875)
	end,
	})